...
<body>
    <div class="print-container">
        ...
        <div class="header">
            ...
            <div class="subtitle">تفاصيل المصروفات حسب التصنيف</div>
            <div class="date-info">
        ...
        @php
            ...
            $categoryCount = count($reportData['by_category'] ?? []);
        @endphp

        <div class="summary-grid">
            <div class="summary-box highlight">
                <div class="label">إجمالي المصروفات</div>
                <div class="value negative">{{ number_format($summary['total_amount'], 2) }}</div>
            </div>
            <div class="summary-box">
                <div class="label">عدد المصروفات</div>
                <div class="value">{{ number_format($summary['total_count']) }}</div>
            </div>
            <div class="summary-box">
                <div class="label">عدد التصنيفات</div>
                <div class="value">{{ number_format($categoryCount) }}</div>
            </div>
            <div class="summary-box">
                <div class="label">متوسط المصروف</div>
                <div class="value">{{ number_format($summary['average'], 2) }}</div>
            </div>
        </div>
        ...
        <div class="two-columns">
            ...
            <div class="section">
                <div class="section-title">حسب التاريخ</div>
                <table>
                    <thead>
                        <tr>
                            <th>التاريخ</th>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left text-negative">{{ number_format($row['amount'], 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <td class="text-left text-negative">{{ number_format($summary['total_amount'], 2) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
