...
<body>
    ...
    <div class="page-header">
        <div class="store-info">
            <img src="{{ asset('logo-dark.png') }}" alt="{{ config('app.name') }}" class="store-logo">
    ...
    <div class="document-title">كشف حساب زبون</div>
    ...
    <div class="customer-section">
        <div class="customer-info">
            ...
            <div class="info-row">
                ...
                <span class="info-value" dir="ltr" style="text-align: right;">{{ $customer->phone }}</span>
            </div>
            <div class="info-row">
        ...
        <table class="ledger-table">
            ...
            <tbody>
                <tr class="opening-row">
                    <td class="col-num">-</td>
                    <td class="col-date">{{ $dateFrom ?? $customer->created_at->format('Y-m-d') }}</td>
                    <td class="col-ref">-</td>
                ...
                <tr>
                    ...
                    <td class="col-balance {{ $transaction->computed_balance > 0 ? 'balance-positive' : ($transaction->computed_balance < 0 ? 'balance-negative' : '') }}">{{ number_format($transaction->computed_balance, 2) }}</td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>
    ...
    <div class="page-footer">
        <div class="signatures">
            ...
            <div class="signature-box">
                <div class="signature-line">توقيع الزبون</div>
            </div>
        </div>
