...
<style>
    ...
    @media (max-width: 767.98px) {
        ...
        .customer-header .flex-grow-1 {
            width: 100%;
            margin-bottom: 0.25rem;
        }
        .customer-header .stat-item {
            ...
            <div class="tab-pane fade" id="ledger">
                <div class="row mb-3 g-2 align-items-end">
                    ...
                    <div class="col-12 col-md-auto ms-md-auto">
                        <a href="{{ route('customers.account.print', $customer) }}" target="_blank" class="btn btn-outline-dark btn-sm w-100" id="printStatementBtn" title="طباعة كشف الحساب">
